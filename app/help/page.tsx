...
import { Brain, ArrowLeft, Users, Calendar, MessageSquare, BarChart3, CheckCircle2, Heart, AlertCircle, FileText } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold">Guía del Sistema</h1>
                <p className="text-xs text-muted-foreground">Bienestar Estudiantil</p>
              </div>
            </div>
            <Link href="/login">
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        {/* Introduction */}
        <div className="mb-12">
          <h2 className="text-4xl font-bold mb-4">Manual de Usuario</h2>
          <p className="text-xl text-muted-foreground text-pretty">
            Aprende a utilizar todas las funcionalidades del Sistema de Bienestar Estudiantil
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Accede a "Mi Estado Emocional" desde el menú lateral</p>
                  <p><strong>2.</strong> Selecciona tu ánimo del día (1-5) usando los emojis</p>
                  <p><strong>3.</strong> Agrega notas opcionales sobre cómo te sientes</p>
                  <p><strong>4.</strong> Visualiza tu evolución en el gráfico de tendencias</p>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Ve a "Mis Estudiantes" para ver tu lista completa</p>
                  <p><strong>2.</strong> Filtra por nivel de riesgo (bajo, medio, alto)</p>
                  <p><strong>3.</strong> Busca por nombre, ID o programa académico</p>
                  <p><strong>4.</strong> Haz click en un estudiante para ver su perfil detallado</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Accede a "Sesiones" desde el menú</p>
                  <p><strong>2.</strong> Click en "Nueva Sesión" para crear una cita</p>
                  <p><strong>3.</strong> Selecciona estudiante, fecha, hora y tipo de sesión</p>
                  <p><strong>4.</strong> Las sesiones se sincronizan con el estudiante automáticamente</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Entra al perfil del estudiante</p>
                  <p><strong>2.</strong> Click en "Asignar Tarea" en la pestaña de tareas</p>
                  <p><strong>3.</strong> Describe la tarea y establece fecha de vencimiento</p>
                  <p><strong>4.</strong> Monitorea el progreso y agrega retroalimentación</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Visualiza gráficos de evolución emocional de cada estudiante</p>
                  <p><strong>2.</strong> Revisa el historial completo de registros de ánimo</p>
                  <p><strong>3.</strong> Detecta patrones y tendencias preocupantes</p>
                  <p><strong>4.</strong> Exporta reportes para análisis detallado</p>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Ve a "Mis Tutorías" y click en "Nueva Tutoría"</p>
                  <p><strong>2.</strong> Selecciona estudiante, fecha, hora y tipo</p>
                  <p><strong>3.</strong> Agrega tema a tratar y ubicación</p>
                  <p><strong>4.</strong> Registra notas después de la sesión</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Ve a "Mis Estudiantes" y selecciona un alumno</p>
                  <p><strong>2.</strong> Revisa información académica y desempeño</p>
                  <p><strong>3.</strong> Consulta historial de tutorías previas</p>
                  <p><strong>4.</strong> Monitorea progreso académico por materia</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Accede a "Reportes" para ver estadísticas</p>
                  <p><strong>2.</strong> Visualiza estudiantes con mejor y peor desempeño</p>
                  <p><strong>3.</strong> Analiza rendimiento por materia</p>
                  <p><strong>4.</strong> Exporta datos en PDF, Excel o CSV</p>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Accede a "Reportes" para estadísticas globales</p>
                  <p><strong>2.</strong> Filtra por período (semanal, mensual, anual)</p>
                  <p><strong>3.</strong> Visualiza gráficos de sesiones, estudiantes y riesgos</p>
                  <p><strong>4.</strong> Exporta reportes en múltiples formatos</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Dashboard principal muestra alertas activas</p>
                  <p><strong>2.</strong> Casos críticos resaltados en rojo</p>
                  <p><strong>3.</strong> Distribución de niveles de riesgo en gráficos</p>
                  <p><strong>4.</strong> Notificaciones automáticas de casos urgentes</p>
              ...
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  <p><strong>1.</strong> Revisa logs de actividad del sistema</p>
                  <p><strong>2.</strong> Monitorea accesos y cambios realizados</p>
                  <p><strong>3.</strong> Detecta anomalías en el uso</p>
                  <p><strong>4.</strong> Genera reportes de cumplimiento normativo</p>
