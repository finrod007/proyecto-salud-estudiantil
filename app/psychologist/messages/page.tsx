...
import { Users, Calendar, MessageSquare, LayoutDashboard, Send, Paperclip } from 'lucide-react'
...
export default function PsychologistMessagesPage() {
  ...
  const loadMessages = () => {
    const userMessages = dataStore.getMessages('PSY-001')
              ...
              <div className="space-y-4">
                {messages.length > 0 ? (
                  messages.map((message) => {
                    const isOwn = message.from === 'PSY-001'
                    return (
                      <div
                        key={message.id}
